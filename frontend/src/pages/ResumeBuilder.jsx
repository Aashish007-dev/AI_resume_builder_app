            ...
            <div className='grid lg:grid-cols-12 gap-8'>
                      ...
                      <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                              ...
                              <button className='bg-gradient-to-r from-indigo-100 to-indigo-200 ring-indigo-300 text-indigo-600 ring hover:ring-indigo-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                                Save Changes
                              </button>
                      ...
                      <div className='lg:col-span-7  max-lg:mt-6'>
                                <div className='relative w-full'>
                                  ...
                                  <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                                    ...
                                    className='flex items-center py-2 px-6 gap-2 text-xs bg-gradient-to-br from-indigo-100 to-indigo-200 text-indigo-600 ring-indigo-300 rounded-lg hover:ring transition-colors'>
